...
public class ItemHolyFruitCassiu extends ItemBase
{
    public ItemHolyFruitCassiu(String name) {
        super(name);
    }
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if (worldIn.isRemote)
            ...
            maid = new EntityMagicMaidCassiu(worldIn);
    ...
    {
        tooltip.add(TextFormatting.YELLOW + "诡异而邪恶的物品，强大的邪恶能量隐隐作显");
        tooltip.add(TextFormatting.YELLOW + "右键使用来召唤卡修");
    }
