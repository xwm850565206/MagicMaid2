...
public class EntityMagicMaidAiliBoss extends EntityMagicMaidAili implements IEntityBossCreature
{
    ...
    public EntityMagicMaidAiliBoss(World worldIn) {
        super(worldIn);
    ...
    public void onLivingUpdate()
    {
        ...
        if (MagicEquipmentRegistry.getAttribute(this.getWeaponType()) == MagicEquipmentRegistry.NONE && !world.isRemote) {
            ...
            if (f < 0.5)
                stack = new ItemStack(ItemInit.UNREAL_RING);
            else
                stack = new ItemStack(ItemInit.UNREAL_BALL);
        ...
        if (MagicEquipmentRegistry.getAttribute(this.getArmorType()) == MagicEquipmentRegistry.NONE) {
            ItemStack stack = new ItemStack(ItemInit.FOX_ARMOR);
    ...
    protected ResourceLocation getLootTable()
    {
        ...
        return equipment == EquipmentInit.UNREAL_RING ? LootTableInit.UNREAL_RING : LootTableInit.UNREAL_BALL;
    }
