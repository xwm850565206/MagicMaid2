...
public class TileEntityForestPortalRenderer extends TileEntitySpecialRenderer<TileEntityForestPortal>
{
    ...
    public void render(TileEntityForestPortal te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        renderBackground(te, x, y, z);
        renderFront(te, x, y, z);
    }

    protected void renderBackground(TileEntityForestPortal te, double x, double y, double z)
    {
    ...
    protected void renderFront(TileEntityForestPortal te, double x, double y, double z)
    {
        GlStateManager.disableLighting();
        GlStateManager.getFloat(GL11.GL_MODELVIEW_MATRIX, MODELVIEW);
        GlStateManager.getFloat(GL11.GL_PROJECTION_MATRIX, PROJECTION);
