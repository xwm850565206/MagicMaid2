...
public class SkillToNormalLand extends PerformSkillUnreachableBase {
    ...
    public void teleport(EntityLivingBase playerIn) {
        ...
        String command = "forge setdimension " + playerIn.getName() + " " + DimensionInit.DIMENSION_NORMAL_LAND + " 100 70 0";
    ...
    public void drawIcon(float x, float y, float scale) {
        ...
        Minecraft.getMinecraft().ingameGUI.drawTexturedModalRect(0, 0, 80, 0, 40, 40);
        GlStateManager.popMatrix();
    }

    @Override
    public String getName() {
        return super.getName() + ".to_normal_land";
    }
