...
public class RenderEntityHeavenArrow extends RenderArrow<EntityHeavenArrow>
{
    ...
    public RenderEntityHeavenArrow(RenderManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void doRender(EntityHeavenArrow entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        {
            GlStateManager.pushMatrix();
            GlStateManager.color(1 - j * 1.0f/ 3, 1 - j * 1.0f/ 3, 1 - j * 1.0f/ 3, 0.6f + 0.4f*j/10.0f);
            GlStateManager.translate(1.5 *j, 0, 0);
            GlStateManager.scale(0, 1, 1);
            sphere.draw(8*(1 - j/10.0f), 10, 10);
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityHeavenArrow entity) {
        return ARROW;
    }
}
