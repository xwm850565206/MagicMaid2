...
public class RenderEntityMagicMaidXimo extends RenderBase {
    public RenderEntityMagicMaidXimo(RenderManager renderManager) {
        super(renderManager, new ModelXimo());
