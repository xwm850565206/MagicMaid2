...
public class ForestTeleporter extends Teleporter
{
    public static BlockPos aimPos = new BlockPos(100, 60, 0);
    private final Random random;

    public ForestTeleporter(WorldServer worldIn)
    {
        super(worldIn);
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw)
    {
       ...
       if (this.destinationCoordinateCache.containsKey(l))
        ...
        {
            BlockPos blockpos3 = world.provider.getDimension() == DimensionInit.DIMENSION_RUIN_FOREST ? new BlockPos(aimPos.add(0, 2, 0)) : new BlockPos(entityIn);
