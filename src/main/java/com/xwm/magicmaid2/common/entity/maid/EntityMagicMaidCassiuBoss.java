...
public class EntityMagicMaidCassiuBoss extends EntityMagicMaidCassiu implements IEntityBossCreature
{
    ...
    public EntityMagicMaidCassiuBoss(World worldIn) {
        super(worldIn);
    ...
    public void onLivingUpdate()
    {
        ...
        if (MagicEquipmentRegistry.getAttribute(this.getWeaponType()) == MagicEquipmentRegistry.NONE && !world.isRemote) {
            ...
            if (f < 0.5)
                stack = new ItemStack(ItemInit.DARK_SOUL);
            else
                stack = new ItemStack(ItemInit.DARK_CLAW);
        ...
        if (MagicEquipmentRegistry.getAttribute(this.getArmorType()) == MagicEquipmentRegistry.NONE){
            ItemStack stack = new ItemStack(ItemInit.BANSHEE_VEIL);
    ...
    protected ResourceLocation getLootTable()
    {
        ...
        EquipmentAttribute equipment = MagicEquipmentRegistry.getAttribute(getWeaponType());
         return equipment == EquipmentInit.DARK_CLAW ? LootTableInit.DARK_CLAW : LootTableInit.DAARK_SOUL;
    }
