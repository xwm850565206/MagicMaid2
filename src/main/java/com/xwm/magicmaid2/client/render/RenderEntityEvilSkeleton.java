...
import com.xwm.magicmaid2.client.model.entity.ModelEvilSkeletonFighter;
...
public class RenderEntityEvilSkeleton extends GeoEntityRenderer<EntityEvilSkeleton> {
    protected RenderEntityEvilSkeleton(RenderManager renderManager) {
        super(renderManager, new ModelEvilSkeletonFighter());
        this.addLayer(new LayerWeaponEvilSkeleton(this));
    }


    @Override
    public void doRender(EntityEvilSkeleton entity, double x, double y, double z, float entityYaw, float partialTicks) {
