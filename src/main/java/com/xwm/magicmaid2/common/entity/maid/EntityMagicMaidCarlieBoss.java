...
public class EntityMagicMaidCarlieBoss extends EntityMagicMaidCarlie implements IEntityBossCreature
{
    ...
    public EntityMagicMaidCarlieBoss(World worldIn) {
        super(worldIn);
    ...
    public void onLivingUpdate()
    {
        ...
        if (MagicEquipmentRegistry.getAttribute(this.getWeaponType()) == MagicEquipmentRegistry.NONE) {
            ...
            if (f < 0.5)
                stack = new ItemStack(ItemInit.STAR_ARROW);
            else
                stack = new ItemStack(ItemInit.HEAVEN_ARROW);
        ...
        if (MagicEquipmentRegistry.getAttribute(this.getArmorType()) == MagicEquipmentRegistry.NONE){
            ItemStack stack = new ItemStack(ItemInit.STAR_BOW);
    ...
    protected ResourceLocation getLootTable()
    {
        ...
        return equipment == EquipmentInit.STAR_ARROW ? LootTableInit.STAR_ARROW : LootTableInit.HEAVEN_ARROW;
    }
