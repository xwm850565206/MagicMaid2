...
public class BlockHolyCross extends BlockBase implements ITileEntityProvider {
    private Random random = new Random();
    public static final PropertyDirection FACING = PropertyDirection.create("facing");
    protected static final AxisAlignedBB FULL_BLOCK_AABB = new AxisAlignedBB(0, 0, 0.45, 1, 1, 0.65);

    public BlockHolyCross(String name) {
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityHolyCross();
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced) {
        ...
        tooltip.add(TextFormatting.YELLOW + "在被恶彻底污染的地区被发现的十字章");
