...
public class StructureRuinForestStructurePieces
{
    ...
    public static void startRuinForest(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructureComponent> componentList, Random random)
    {
        ...
        addHelper(componentList, StructureRuinForestStructurePieces.addPiece(templateManager, structureRuinForestPieces$ruintemplate, new BlockPos(30, 8, 0), "dedication_exp_pool", Rotation.CLOCKWISE_180, true));
        addHelper(componentList, StructureRuinForestStructurePieces.addPiece(templateManager, structureRuinForestPieces$ruintemplate, new BlockPos(60, 6, 5), "dedication_life_pool", Rotation.CLOCKWISE_180, true));
        addHelper(componentList, StructureRuinForestStructurePieces.addPiece(templateManager, structureRuinForestPieces$ruintemplate, new BlockPos(50, 8, 30), "sacrifice_pool", Rotation.CLOCKWISE_180, true));
        addHelper(componentList, StructureRuinForestStructurePieces.addPiece(templateManager, structureRuinForestPieces$ruintemplate, new BlockPos(60, 7, 25), "maier_hut", Rotation.NONE, true));
    }
